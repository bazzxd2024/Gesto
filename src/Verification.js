                ...
                <div className='enrollment-report'>
                    ...
                    <div className='form-body'>
                        <p>
                            ...
                            <br />
                            Are you a third party needing to verify a Candidate Education credentials?
                            <br />
                            <br />
                            Following options are available.
                            <br />
                            Online Enrolment Verification Profile GESTO students can Provide Student Name &amp; Registration Number to the third parties (i.e. login details) to verify the information in Official Institution Web Page. Third Party Can Verify All the Candidate Details Like Examination Records / Enrollment Records / Curriculum Records Etc.
                            Email Verification If the above options do not meet the request need, or you need to request additional student information Please Send your request, together with a completed Set of Student Educational Credential and signed copy to: Infogestohyderabad@gmail.com. Buffer Waiting Time of the Institution to Revert to the Third Parties Will be From 24 Hours and Last Upto 72 Hours. Exempting Public &amp; National Holidays
                        </p>
                    </div>
            ...
            < footer className="footer" >
                <div className='footer-content'>
                    ...
                    <div className="address">
                        <h3>Address</h3>
                        <p> D-No-1-8-613, Prakash Nagar, <br></br>
